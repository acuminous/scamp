...
const ScampEvents  = require('../enums/ScampEvent');
...
module.exports = class StickyChannelSource {
  ...
  async getChannel() {
    return this._getChannel(CHANNEL_TYPE.REGULAR, () => this._channelSource.getChannel());
  }

  async getConfirmChannel() {
    return this._getChannel(CHANNEL_TYPE.CONFIRM, () => this._channelSource.getConfirmChannel());
  }
