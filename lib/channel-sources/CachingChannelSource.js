...
const { ChannelTypes, ScampEvents }  = require('../enums');
...
module.exports = class CachingChannelSource {
  ...
  async getChannel() {
    return this._getChannel(ChannelTypes.REGULAR, () => this._channelSource.getChannel());
  }

  async getConfirmChannel() {
    return this._getChannel(ChannelTypes.CONFIRM, () => this._channelSource.getConfirmChannel());
  }
