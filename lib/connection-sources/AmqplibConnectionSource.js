...
module.exports = class AmqplibConnectionSource {
  ...
  async _connect() {
    ...
    const connection = await this._amqplib.connect(this._connectOptions.connectionOptions, this._connectOptions.socketOptions);
    this._decorator.decorate(this._connectOptions.loggableUrl, connection);
