...
module.exports = class HighAvailabiltyConnectionSource {
  ...
  constructor({ amqplib, optionSets }) {
    ...
    const multiConnectionSource = new RotatingConnectionSource({ connectionSources: amqplibConnectionSources });
    const stickyConnectionSource = new StickyConnectionSource({ connectionSource: multiConnectionSource });
